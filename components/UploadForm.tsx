  ...
  return (
    <>
      <form
        ...
        autoComplete={"off"}
      >
        <h1 className="text-4xl font-light my-8 text-d-purple text-center">Upload</h1>
        ...
        <div className="relative my-4 py-6 row-span-1 border-2 rounded-lg border-dashed border-gray-500 w-full grid place-items-center">
          <label
            htmlFor="imageUpload"
            className="w-full h-full grid place-items-center block text-lg font-light text-d-green"
          >
            <svg
        ...
        <div className="my-4 row-span-1 w-full h-20 grid grid-rows-3 grid-cols-1 gap-2">
          ...
          <input
            ...
            name="imageLabel"
            id="imageLabel"
            className="px-4 row-span-2 h-full w-full bg-transparent border focus:outline-none border-gray-500 p-2 text-sm text-d-green font-light"
            required={true}
          />
        </div>
        <div className="my-4 row-span-1 w-full h-32 grid grid-rows-3 grid-cols-1 gap-2">
          ...
          <textarea
            ...
            id="imageDescription"
            className="row-span-4 h-full w-full bg-transparent border focus:outline-none border-gray-500 p-2 text-sm text-d-green font-light resize-none"
            required={true}
          ></textarea>
        </div>
        ...
        <div className="my-4 row-span-1 w-full h-20 grid grid-rows-3 grid-cols-1 gap-2">
          <input
            ...
            id="submit"
            value="Upload"
            className="cursor-pointer row-start-2 row-span-2 h-full w-full max-w-xs mx-auto border focus:outline-none border-gray-600 bg-gray-600 hover:bg-gray-800 text-d-green"
          />
        </div>
        <Link href="/" passHref>
          <p className="text-sm font-light text-d-green text-center underline cursor-pointer">
            Go Home
          </p>
        </Link>
      </form>
